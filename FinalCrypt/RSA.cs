...
{
    class RSA //Nguồn: https://dinhnn.com/2014/09/03/rsa-ta%CC%A3o-key-pairs-d%CC%89-ma%CC%83-hoa-encrypt-va-gia%CC%89i-ma%CC%83-decrypt/
    {
        #region Private Fields

        private int KEY_SIZE = 2048; // The size of the RSA key to use in bits.
